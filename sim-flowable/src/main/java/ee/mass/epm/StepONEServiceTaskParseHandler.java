...
public class StepONEServiceTaskParseHandler extends ServiceTaskParseHandler {

    private static final Logger LOGGER = LoggerFactory.getLogger(StepONEServiceTaskParseHandler.class);
    ...
    protected void executeParse(BpmnParse bpmnParse, ServiceTask serviceTask) {
        ...
        if (StringUtils.isNotEmpty(serviceTask.getType())) {
            ...
            } else if (serviceTask.getType().startsWith("stepone")) {
