...
public class EventLogPanel extends JPanel
	implements ConnectionListener, MessageListener, ActionListener, ApplicationListener {
	...
	public static final String APP_EVENT_UI_MSG = "ApplicationEventMessage";
	...
	private EventLogControl appEventsCheck;
	...
	private EventLogControlPanel createControls() {
		...
		c.addHeading("applications");
		appEventsCheck = c.addControl("events");
	...
	public void gotEvent(String event, Object params, Application app, DTNHost host) {
		if (event.equals(EventLogPanel.APP_EVENT_UI_MSG)){
			String msg = (String) params;
			processEvent(appEventsCheck, String.format("App Event: %s", msg), host, null, null);
		}
	}
