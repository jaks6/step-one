 ...
 */
public class ProcessInfoWindow extends JFrame implements ActionListener {
    ...
    public ProcessInfoWindow(DTNHost host) {
    ...
    private void updateTree() {
        super.setTitle("Processes Info of " + host + " at " +
    ...
    private void addChildren(DefaultMutableTreeNode node, BpmInfo info) {
        for (BpmInfo ri : info.getMoreInfo()) {
